...
const getStaticProps = async () => {
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://admin_phu:!12345678Pp@cluster1.bbt1icp.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
